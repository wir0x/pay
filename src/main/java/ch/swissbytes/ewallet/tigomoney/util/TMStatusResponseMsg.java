...
public class TMStatusResponseMsg {

    private final static Logger log = LogManager.getLogger(TMStatusResponseMsg.class);
    private static final Locale locale = new Locale("es", "ES");
    private static final String RESOURCE_BUNDLE_NAME = "TMCheckStatus";
